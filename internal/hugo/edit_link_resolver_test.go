...
func TestEditLinkResolver_BasicForgeTypes(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			cfg:        &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "gh", Type: config.ForgeGitHub, BaseURL: "https://github.com", APIURL: "https://api.github.com", Organizations: []string{"org"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("https://github.com/org/repo1.git", "repo1", "main", "docs")}},
		...
		},
		{
			name:       "forgejo basic",
			theme:      config.ThemeHextra,
			cfg:        &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "fj", Type: config.ForgeForgejo, BaseURL: "https://code.example.org", APIURL: "https://code.example.org/api/v1", Groups: []string{"team"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("https://code.example.org/team/project.git", "project", "main", "docs")}},
		...
		},
		{
			...
			theme: config.ThemeHextra,
			cfg:   &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "gh", Type: config.ForgeGitHub, BaseURL: "https://github.com", APIURL: "https://api.github.com", Organizations: []string{"org"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("git@github.com:org/repo2.git", "repo2", "", "docs")}},
		...
		},
		{
			...
			theme:      config.ThemeHextra,
			cfg:        &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "gh", Type: config.ForgeGitHub, BaseURL: "https://github.com", APIURL: "https://api.github.com", Organizations: []string{"org"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("https://github.com/org/repo3.git", "repo3", "main", ".")}},
		...
		},
		{
			...
			theme:      config.ThemeHextra,
			cfg:        &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "gh", Type: config.ForgeGitHub, BaseURL: "https://github.com", APIURL: "https://api.github.com", Organizations: []string{"org"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("https://github.com/org/repo4.git", "repo4", "main", "documentation/guides")}},
		...
		},
		{
			...
			theme:      config.ThemeHextra,
			cfg:        &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "gh", Type: config.ForgeGitHub, BaseURL: "https://github.com", APIURL: "https://api.github.com", Organizations: []string{"org"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("https://github.com/org/repo5.git", "repo5", "main", "docs/")}},
		...
		},
		{
			...
			theme:      config.ThemeHextra,
			cfg:        &config.Config{Hugo: config.HugoConfig{Theme: string(config.ThemeHextra)}, Forges: []*config.ForgeConfig{{Name: "gh", Type: config.ForgeGitHub, BaseURL: "https://github.com", APIURL: "https://api.github.com", Organizations: []string{"org"}, Auth: &config.AuthConfig{Type: config.AuthTypeToken}}}, Repositories: []config.Repository{repo("https://github.com/org/repo6.git", "repo6", "main", "docs/../docs/guides")}},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.cfg.Hugo.Theme = string(tt.theme)
