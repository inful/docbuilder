...
func ComputeBaseFrontMatter(name, repository, forge, section string, metadata map[string]any, existing map[string]any, cfg *config.Config, now time.Time) map[string]any {
	fm := map[string]any{}
