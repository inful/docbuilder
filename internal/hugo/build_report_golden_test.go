...
func TestBuildReportGolden(t *testing.T) {
	...
	// Required keys
	required := []string{"repositories","files","start","end","errors","warnings","stage_durations","stage_error_kinds","cloned_repositories","failed_repositories","skipped_repositories","rendered_pages","stage_counts","outcome","static_rendered","retries","retries_exhausted"}
