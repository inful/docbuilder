...
func TestGoldenOrdering(t *testing.T) {
	...
	const expectedJSON = `["front_matter_parser","front_matter_builder_v2","edit_link_injector_v2","front_matter_merge","relative_link_rewriter","shortcode_escaper","front_matter_serialize"]`
	if got != expectedJSON {
