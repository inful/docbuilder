...
func (g *Generator) addDocsyParams(params map[string]interface{}) {
	...
	if params["ui"] == nil {
		params["ui"] = map[string]interface{}{"sidebar_menu_compact": false, "sidebar_menu_foldable": true, "breadcrumb_disable": false, "taxonomy_breadcrumb_disable": false, "footer_about_disable": false, "navbar_logo": true, "navbar_translucent_over_cover_disable": false, "sidebar_search_disable": false}
	}
	if params["links"] == nil {
...
func (g *Generator) addHextraParams(params map[string]interface{}) {
	...
	if _, ok := params["theme"].(map[string]interface{}); !ok {
		params["theme"] = map[string]interface{}{"default": "system", "displayToggle": true}
	}
	if params["ui"] == nil {
		params["ui"] = map[string]interface{}{"navbar_logo": true, "sidebar_menu_foldable": true, "sidebar_menu_compact": false, "sidebar_search_disable": false}
	}
	...
	if _, ok := params["navbar"].(map[string]interface{}); !ok {
		params["navbar"] = map[string]interface{}{"width": "normal"}
	}
}
